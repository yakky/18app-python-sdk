...
class API(object):
    def __init__(self, endpoint, wsdl, certificate, certificate_password, keystore, merchant):
        """
        ...
        :param certificate_password: absolute path to client private key (PEM format)
