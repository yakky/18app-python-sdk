...
sys.path.append('..')
from python_18app import __version__

# -- PROJECT Variables ----------------------------------------------------
settings_project_name = 'SDK Python per 18App - Merchant'
settings_copyright_copyleft = 'BSD - Developers Italia'
settings_editor_name = '- Developers Italia'
settings_doc_version = __version__
settings_doc_release = settings_doc_version
settings_basename = '18app-python-sdk'
settings_file_name = '18app-python-sdk'
